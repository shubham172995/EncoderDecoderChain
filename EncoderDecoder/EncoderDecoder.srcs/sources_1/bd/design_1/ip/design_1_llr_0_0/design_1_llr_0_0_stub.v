...
//               /home/shubham/Vivado_Exercises/EncoderDecoder/EncoderDecoder.srcs/sources_1/bd/design_1/ip/design_1_llr_0_0/design_1_llr_0_0_stub.v
...
module design_1_llr_0_0(ap_clk, ap_rst_n, ap_start, ap_done, ap_idle, 
  ap_ready, dt_TVALID, dt_TREADY, dt_TDATA, dt_TLAST, ctrl_V_TVALID, ctrl_V_TREADY, ctrl_V_TDATA, 
  din_TVALID, din_TREADY, din_TDATA, din_TLAST, control_V_TVALID, control_V_TREADY, 
...
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,dt_TVALID,dt_TREADY,dt_TDATA[127:0],dt_TLAST[0:0],ctrl_V_TVALID,ctrl_V_TREADY,ctrl_V_TDATA[31:0],din_TVALID,din_TREADY,din_TDATA[127:0],din_TLAST[0:0],control_V_TVALID,control_V_TREADY,control_V_TDATA[31:0],din_words_TVALID,din_words_TREADY,din_words_TDATA[7:0],din_words_TLAST[0:0],dout_words_TVALID,dout_words_TREADY,dout_words_TDATA[7:0],dout_words_TLAST[0:0]" */;
  input ap_clk;
  input ap_rst_n;
  input ap_start;
  output ap_done;
