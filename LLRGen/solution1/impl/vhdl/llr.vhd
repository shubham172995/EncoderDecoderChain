...
architecture behav of llr is 
    ...
    "llr,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu28dr-ffvg1517-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.300297,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1064,HLS_SYN_LUT=440,HLS_VERSION=2018_3}";
    ...
    signal ctrl_V_0_vld_in : STD_LOGIC;
    signal ctrl_V_0_vld_out : STD_LOGIC;
    signal ctrl_V_0_ack_in : STD_LOGIC;
    ...
    signal ctrl_V_0_sel_rd : STD_LOGIC := '0';
    signal ctrl_V_0_sel_wr : STD_LOGIC := '0';
    signal ctrl_V_0_sel : STD_LOGIC;
    signal ctrl_V_0_load_A : STD_LOGIC;
    signal ctrl_V_0_load_B : STD_LOGIC;
    signal ctrl_V_0_state : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal ctrl_V_0_state_cmp_full : STD_LOGIC;
    ...
    signal control_V_1_sel_wr : STD_LOGIC := '0';
    ...
    signal control_V_1_state_cmp_full : STD_LOGIC;
    ...
    signal ctrl_V_TDATA_blk_n : STD_LOGIC;
    signal din_TDATA_blk_n : STD_LOGIC;
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_7_fu_143_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal temp_data_V_1_fu_159_p1 : STD_LOGIC_VECTOR (127 downto 0);
    signal temp_data_V_1_reg_192 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal ap_block_state3_io : BOOLEAN;
    signal tmp_tlast_fu_163_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_data_V_4_cast_fu_170_p3 : STD_LOGIC_VECTOR (127 downto 0);
    signal lhs_V_reg_122 : STD_LOGIC_VECTOR (127 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal tmp_1_fu_135_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_4_fu_149_p4 : STD_LOGIC_VECTOR (126 downto 0);
    signal tmp_2_fu_139_p1 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    control_V_1_sel_wr_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                control_V_1_sel_wr <= ap_const_logic_0;
            else
                if (((control_V_1_ack_in = ap_const_logic_1) and (control_V_1_vld_in = ap_const_logic_1))) then 
                                        control_V_1_sel_wr <= not(control_V_1_sel_wr);
                end if; 
            end if;
        end if;
    end process;
    ...
    ctrl_V_0_sel_rd_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ctrl_V_0_sel_rd <= ap_const_logic_0;
            else
                if (((ctrl_V_0_ack_out = ap_const_logic_1) and (ctrl_V_0_vld_out = ap_const_logic_1))) then 
                                        ctrl_V_0_sel_rd <= not(ctrl_V_0_sel_rd);
                end if; 
            end if;
        end if;
    end process;
    ...
    ctrl_V_0_sel_wr_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ctrl_V_0_sel_wr <= ap_const_logic_0;
            else
                if (((ctrl_V_0_ack_in = ap_const_logic_1) and (ctrl_V_0_vld_in = ap_const_logic_1))) then 
                                        ctrl_V_0_sel_wr <= not(ctrl_V_0_sel_wr);
                end if; 
            end if;
        end if;
    end process;
    ...
    ctrl_V_0_state_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ctrl_V_0_state <= ap_const_lv2_0;
            else
                if ((((ctrl_V_0_state = ap_const_lv2_2) and (ctrl_V_0_vld_in = ap_const_logic_0)) or ((ctrl_V_0_state = ap_const_lv2_3) and (ctrl_V_0_vld_in = ap_const_logic_0) and (ctrl_V_0_ack_out = ap_const_logic_1)))) then 
                    ctrl_V_0_state <= ap_const_lv2_2;
                elsif ((((ctrl_V_0_state = ap_const_lv2_1) and (ctrl_V_0_ack_out = ap_const_logic_0)) or ((ctrl_V_0_state = ap_const_lv2_3) and (ctrl_V_0_ack_out = ap_const_logic_0) and (ctrl_V_0_vld_in = ap_const_logic_1)))) then 
                    ctrl_V_0_state <= ap_const_lv2_1;
                elsif (((not(((ctrl_V_0_vld_in = ap_const_logic_0) and (ctrl_V_0_ack_out = ap_const_logic_1))) and not(((ctrl_V_0_ack_out = ap_const_logic_0) and (ctrl_V_0_vld_in = ap_const_logic_1))) and (ctrl_V_0_state = ap_const_lv2_3)) or ((ctrl_V_0_state = ap_const_lv2_1) and (ctrl_V_0_ack_out = ap_const_logic_1)) or ((ctrl_V_0_state = ap_const_lv2_2) and (ctrl_V_0_vld_in = ap_const_logic_1)))) then 
    ...
    lhs_V_reg_122_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((control_V_1_load_A = ap_const_logic_1)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((control_V_1_load_B = ap_const_logic_1)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ctrl_V_0_load_A = ap_const_logic_1)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ctrl_V_0_load_B = ap_const_logic_1)) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((din_V_tlast_1_load_A = ap_const_logic_1)) then
                din_V_tlast_1_payload_A <= tmp_tlast_fu_163_p2(0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((din_V_tlast_1_load_B = ap_const_logic_1)) then
                din_V_tlast_1_payload_B <= tmp_tlast_fu_163_p2(0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                tmp_data_V_reg_184 <= dt_V_data_V_0_data_out;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, din_V_data_V_1_ack_in, din_V_data_V_1_state, din_V_tlast_1_ack_in, din_V_tlast_1_state, control_V_1_ack_in, control_V_1_state, din_words_V_data_V_1_ack_in, din_words_V_data_V_1_state, din_words_V_tlast_1_ack_in, din_words_V_tlast_1_state, dout_words_V_data_V_1_ack_in, dout_words_V_data_V_1_state, dout_words_V_tlast_1_ack_in, dout_words_V_tlast_1_state, ap_CS_fsm_state3, tmp_7_fu_143_p2, ap_CS_fsm_state4, ap_CS_fsm_state2, ap_block_state1_io, ap_block_state3_io, ap_block_state2_io)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if ((not(((dout_words_V_tlast_1_ack_in = ap_const_logic_0) or (dout_words_V_data_V_1_ack_in = ap_const_logic_0) or (din_words_V_tlast_1_ack_in = ap_const_logic_0) or (din_words_V_data_V_1_ack_in = ap_const_logic_0) or (control_V_1_ack_in = ap_const_logic_0) or (din_V_tlast_1_ack_in = ap_const_logic_0) or (din_V_data_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state3_io))) and (tmp_7_fu_143_p2 = ap_const_lv1_1) and (dout_words_V_tlast_1_state(0) = ap_const_logic_0) and (dout_words_V_data_V_1_state(0) = ap_const_logic_0) and (din_words_V_tlast_1_state(0) = ap_const_logic_0) and (din_words_V_data_V_1_state(0) = ap_const_logic_0) and (control_V_1_state(0) = ap_const_logic_0) and (din_V_tlast_1_state(0) = ap_const_logic_0) and (din_V_data_V_1_state(0) = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
    ...
    ap_block_state1_assign_proc : process(ap_start, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out)
    begin
                ap_block_state1 <= ((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0));
    end process;
    ...
    control_V_1_data_out_assign_proc : process(control_V_1_payload_A, control_V_1_payload_B, control_V_1_sel)
    begin
        if ((control_V_1_sel = ap_const_logic_1)) then 
    ...
    control_V_1_load_A <= (not(control_V_1_sel_wr) and control_V_1_state_cmp_full);
    control_V_1_load_B <= (control_V_1_state_cmp_full and control_V_1_sel_wr);
    control_V_1_sel <= control_V_1_sel_rd;
    control_V_1_state_cmp_full <= '0' when (control_V_1_state = ap_const_lv2_1) else '1';

    control_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ctrl_V_0_ack_in <= ctrl_V_0_state(1);

    ctrl_V_0_ack_out_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ctrl_V_0_data_out_assign_proc : process(ctrl_V_0_payload_A, ctrl_V_0_payload_B, ctrl_V_0_sel)
    begin
        if ((ctrl_V_0_sel = ap_const_logic_1)) then 
    ...
    ctrl_V_0_load_A <= (not(ctrl_V_0_sel_wr) and ctrl_V_0_state_cmp_full);
    ctrl_V_0_load_B <= (ctrl_V_0_state_cmp_full and ctrl_V_0_sel_wr);
    ctrl_V_0_sel <= ctrl_V_0_sel_rd;
    ctrl_V_0_state_cmp_full <= '0' when (ctrl_V_0_state = ap_const_lv2_1) else '1';
    ctrl_V_0_vld_in <= ctrl_V_TVALID;
    ctrl_V_0_vld_out <= ctrl_V_0_state(0);

    ctrl_V_TDATA_blk_n_assign_proc : process(ap_start, ap_CS_fsm_state1, ctrl_V_0_state)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
            ctrl_V_TDATA_blk_n <= ctrl_V_0_state(0);
        else 
            ctrl_V_TDATA_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    ctrl_V_TREADY <= ctrl_V_0_state(1);
    din_TDATA <= din_V_data_V_1_data_out;

    din_TDATA_blk_n_assign_proc : process(din_V_data_V_1_state, ap_CS_fsm_state3, tmp_7_fu_143_p2, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or ((tmp_7_fu_143_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3)))) then 
    ...
    din_V_data_V_1_vld_in_assign_proc : process(din_V_data_V_1_ack_in, din_V_tlast_1_ack_in, control_V_1_ack_in, din_words_V_data_V_1_ack_in, din_words_V_tlast_1_ack_in, dout_words_V_data_V_1_ack_in, dout_words_V_tlast_1_ack_in, ap_CS_fsm_state3, tmp_7_fu_143_p2, ap_block_state3_io)
    begin
        if ((not(((dout_words_V_tlast_1_ack_in = ap_const_logic_0) or (dout_words_V_data_V_1_ack_in = ap_const_logic_0) or (din_words_V_tlast_1_ack_in = ap_const_logic_0) or (din_words_V_data_V_1_ack_in = ap_const_logic_0) or (control_V_1_ack_in = ap_const_logic_0) or (din_V_tlast_1_ack_in = ap_const_logic_0) or (din_V_data_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state3_io))) and (tmp_7_fu_143_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    din_V_tlast_1_vld_in_assign_proc : process(din_V_data_V_1_ack_in, din_V_tlast_1_ack_in, control_V_1_ack_in, din_words_V_data_V_1_ack_in, din_words_V_tlast_1_ack_in, dout_words_V_data_V_1_ack_in, dout_words_V_tlast_1_ack_in, ap_CS_fsm_state3, tmp_7_fu_143_p2, ap_block_state3_io)
    begin
        if ((not(((dout_words_V_tlast_1_ack_in = ap_const_logic_0) or (dout_words_V_data_V_1_ack_in = ap_const_logic_0) or (din_words_V_tlast_1_ack_in = ap_const_logic_0) or (din_words_V_data_V_1_ack_in = ap_const_logic_0) or (control_V_1_ack_in = ap_const_logic_0) or (din_V_tlast_1_ack_in = ap_const_logic_0) or (din_V_data_V_1_ack_in = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state3_io))) and (tmp_7_fu_143_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    din_words_V_data_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    din_words_V_tlast_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dout_words_V_data_V_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dout_words_V_tlast_1_vld_in_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dt_V_data_V_0_ack_out_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dt_V_tlast_0_ack_out_assign_proc : process(ap_start, ap_CS_fsm_state1, dt_V_data_V_0_vld_out, ctrl_V_0_vld_out, ap_block_state1_io)
    begin
        if ((not(((dt_V_data_V_0_vld_out = ap_const_logic_0) or (ctrl_V_0_vld_out = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state1_io))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    dt_V_tlast_0_vld_in <= dt_TVALID;
        temp_data_V_1_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_4_fu_149_p4),128));

    tmp_1_fu_135_p1 <= lhs_V_reg_122(64 - 1 downto 0);
    tmp_2_fu_139_p1 <= lhs_V_reg_122(1 - 1 downto 0);
    tmp_4_fu_149_p4 <= lhs_V_reg_122(127 downto 1);
    tmp_7_fu_143_p2 <= "1" when (tmp_1_fu_135_p1 = ap_const_lv64_0) else "0";
    tmp_data_V_4_cast_fu_170_p3 <= 
        ap_const_lv128_lc_1 when (tmp_2_fu_139_p1(0) = '1') else 
        ap_const_lv128_lc_2;
    tmp_tlast_fu_163_p2 <= "1" when (tmp_4_fu_149_p4 = ap_const_lv127_0) else "0";
end behav;
