...
struct llr : public sc_module {
    ...
    sc_in< sc_lv<32> > ctrl_V_TDATA;
    sc_in< sc_logic > ctrl_V_TVALID;
    sc_out< sc_logic > ctrl_V_TREADY;
    ...
    sc_signal< sc_lv<32> > ctrl_V_0_data_out;
    sc_signal< sc_logic > ctrl_V_0_vld_in;
    sc_signal< sc_logic > ctrl_V_0_vld_out;
    sc_signal< sc_logic > ctrl_V_0_ack_in;
    sc_signal< sc_logic > ctrl_V_0_ack_out;
    sc_signal< sc_lv<32> > ctrl_V_0_payload_A;
    sc_signal< sc_lv<32> > ctrl_V_0_payload_B;
    sc_signal< sc_logic > ctrl_V_0_sel_rd;
    sc_signal< sc_logic > ctrl_V_0_sel_wr;
    sc_signal< sc_logic > ctrl_V_0_sel;
    sc_signal< sc_logic > ctrl_V_0_load_A;
    sc_signal< sc_logic > ctrl_V_0_load_B;
    sc_signal< sc_lv<2> > ctrl_V_0_state;
    sc_signal< sc_logic > ctrl_V_0_state_cmp_full;
    ...
    sc_signal< sc_lv<32> > control_V_1_payload_A;
    sc_signal< sc_lv<32> > control_V_1_payload_B;
    sc_signal< sc_logic > control_V_1_sel_rd;
    sc_signal< sc_logic > control_V_1_sel_wr;
    sc_signal< sc_logic > control_V_1_sel;
    sc_signal< sc_logic > control_V_1_load_A;
    sc_signal< sc_logic > control_V_1_load_B;
    sc_signal< sc_lv<2> > control_V_1_state;
    sc_signal< sc_logic > control_V_1_state_cmp_full;
    ...
    sc_signal< sc_logic > ctrl_V_TDATA_blk_n;
    sc_signal< sc_logic > din_TDATA_blk_n;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<1> > tmp_7_fu_143_p2;
    ...
    sc_signal< sc_lv<128> > tmp_data_V_reg_184;
    sc_signal< sc_lv<128> > temp_data_V_1_fu_159_p1;
    sc_signal< sc_lv<128> > temp_data_V_1_reg_192;
    sc_signal< bool > ap_block_state3;
    sc_signal< bool > ap_block_state3_io;
    sc_signal< sc_lv<1> > tmp_tlast_fu_163_p2;
    sc_signal< sc_lv<128> > tmp_data_V_4_cast_fu_170_p3;
    sc_signal< sc_lv<128> > lhs_V_reg_122;
    sc_signal< bool > ap_block_state2_io;
    sc_signal< sc_lv<64> > tmp_1_fu_135_p1;
    sc_signal< sc_lv<127> > tmp_4_fu_149_p4;
    sc_signal< sc_lv<1> > tmp_2_fu_139_p1;
    ...
    void thread_control_V_1_load_A();
    void thread_control_V_1_load_B();
    void thread_control_V_1_sel();
    void thread_control_V_1_state_cmp_full();
    ...
    void thread_ctrl_V_0_ack_in();
    void thread_ctrl_V_0_ack_out();
    void thread_ctrl_V_0_data_out();
    void thread_ctrl_V_0_load_A();
    void thread_ctrl_V_0_load_B();
    void thread_ctrl_V_0_sel();
    void thread_ctrl_V_0_state_cmp_full();
    void thread_ctrl_V_0_vld_in();
    void thread_ctrl_V_0_vld_out();
    void thread_ctrl_V_TDATA_blk_n();
    void thread_ctrl_V_TREADY();
    ...
    void thread_temp_data_V_1_fu_159_p1();
    void thread_tmp_1_fu_135_p1();
    void thread_tmp_2_fu_139_p1();
    void thread_tmp_4_fu_149_p4();
    void thread_tmp_7_fu_143_p2();
    void thread_tmp_data_V_4_cast_fu_170_p3();
    void thread_tmp_tlast_fu_163_p2();
