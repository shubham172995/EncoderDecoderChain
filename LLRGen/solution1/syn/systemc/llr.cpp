...
llr::llr(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( control_V_1_payload_A );
    sensitive << ( control_V_1_payload_B );
    sensitive << ( control_V_1_sel );

    SC_METHOD(thread_control_V_1_load_A);
    sensitive << ( control_V_1_sel_wr );
    sensitive << ( control_V_1_state_cmp_full );

    SC_METHOD(thread_control_V_1_load_B);
    sensitive << ( control_V_1_sel_wr );
    sensitive << ( control_V_1_state_cmp_full );
    ...
    SC_METHOD(thread_control_V_1_state_cmp_full);
    sensitive << ( control_V_1_state );
    ...
    SC_METHOD(thread_ctrl_V_0_ack_in);
    sensitive << ( ctrl_V_0_state );

    SC_METHOD(thread_ctrl_V_0_ack_out);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( dt_V_data_V_0_vld_out );
    sensitive << ( ctrl_V_0_vld_out );
    ...
    SC_METHOD(thread_ctrl_V_0_data_out);
    sensitive << ( ctrl_V_0_payload_A );
    sensitive << ( ctrl_V_0_payload_B );
    sensitive << ( ctrl_V_0_sel );

    SC_METHOD(thread_ctrl_V_0_load_A);
    sensitive << ( ctrl_V_0_sel_wr );
    sensitive << ( ctrl_V_0_state_cmp_full );

    SC_METHOD(thread_ctrl_V_0_load_B);
    sensitive << ( ctrl_V_0_sel_wr );
    sensitive << ( ctrl_V_0_state_cmp_full );

    SC_METHOD(thread_ctrl_V_0_sel);
    sensitive << ( ctrl_V_0_sel_rd );

    SC_METHOD(thread_ctrl_V_0_state_cmp_full);
    sensitive << ( ctrl_V_0_state );

    SC_METHOD(thread_ctrl_V_0_vld_in);
    sensitive << ( ctrl_V_TVALID );

    SC_METHOD(thread_ctrl_V_0_vld_out);
    sensitive << ( ctrl_V_0_state );

    SC_METHOD(thread_ctrl_V_TDATA_blk_n);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( ctrl_V_0_state );

    SC_METHOD(thread_ctrl_V_TREADY);
    sensitive << ( ctrl_V_0_state );
    ...
    SC_METHOD(thread_temp_data_V_1_fu_159_p1);
    sensitive << ( tmp_4_fu_149_p4 );

    SC_METHOD(thread_tmp_1_fu_135_p1);
    sensitive << ( lhs_V_reg_122 );

    SC_METHOD(thread_tmp_2_fu_139_p1);
    sensitive << ( lhs_V_reg_122 );

    SC_METHOD(thread_tmp_4_fu_149_p4);
    sensitive << ( lhs_V_reg_122 );

    SC_METHOD(thread_tmp_7_fu_143_p2);
    sensitive << ( din_V_data_V_1_ack_in );
    sensitive << ( din_V_tlast_1_ack_in );
    sensitive << ( control_V_1_ack_in );
    sensitive << ( din_words_V_data_V_1_ack_in );
    ...
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( ap_block_state3_io );
    sensitive << ( tmp_1_fu_135_p1 );

    SC_METHOD(thread_tmp_data_V_4_cast_fu_170_p3);
    sensitive << ( tmp_2_fu_139_p1 );

    SC_METHOD(thread_tmp_tlast_fu_163_p2);
    sensitive << ( din_V_data_V_1_ack_in );
    sensitive << ( din_V_tlast_1_ack_in );
    sensitive << ( control_V_1_ack_in );
    sensitive << ( din_words_V_data_V_1_ack_in );
    ...
    ctrl_V_0_sel_rd = SC_LOGIC_0;
    ctrl_V_0_sel_wr = SC_LOGIC_0;
    ctrl_V_0_state = "00";
    ...
    sc_trace(mVcdFile, ctrl_V_TDATA, "(port)ctrl_V_TDATA");
    sc_trace(mVcdFile, ctrl_V_TVALID, "(port)ctrl_V_TVALID");
    sc_trace(mVcdFile, ctrl_V_TREADY, "(port)ctrl_V_TREADY");
    ...
    sc_trace(mVcdFile, ctrl_V_0_data_out, "ctrl_V_0_data_out");
    sc_trace(mVcdFile, ctrl_V_0_vld_in, "ctrl_V_0_vld_in");
    sc_trace(mVcdFile, ctrl_V_0_vld_out, "ctrl_V_0_vld_out");
    sc_trace(mVcdFile, ctrl_V_0_ack_in, "ctrl_V_0_ack_in");
    sc_trace(mVcdFile, ctrl_V_0_ack_out, "ctrl_V_0_ack_out");
    sc_trace(mVcdFile, ctrl_V_0_payload_A, "ctrl_V_0_payload_A");
    sc_trace(mVcdFile, ctrl_V_0_payload_B, "ctrl_V_0_payload_B");
    sc_trace(mVcdFile, ctrl_V_0_sel_rd, "ctrl_V_0_sel_rd");
    sc_trace(mVcdFile, ctrl_V_0_sel_wr, "ctrl_V_0_sel_wr");
    sc_trace(mVcdFile, ctrl_V_0_sel, "ctrl_V_0_sel");
    sc_trace(mVcdFile, ctrl_V_0_load_A, "ctrl_V_0_load_A");
    sc_trace(mVcdFile, ctrl_V_0_load_B, "ctrl_V_0_load_B");
    sc_trace(mVcdFile, ctrl_V_0_state, "ctrl_V_0_state");
    sc_trace(mVcdFile, ctrl_V_0_state_cmp_full, "ctrl_V_0_state_cmp_full");
    ...
    sc_trace(mVcdFile, control_V_1_payload_A, "control_V_1_payload_A");
    sc_trace(mVcdFile, control_V_1_payload_B, "control_V_1_payload_B");
    sc_trace(mVcdFile, control_V_1_sel_rd, "control_V_1_sel_rd");
    sc_trace(mVcdFile, control_V_1_sel_wr, "control_V_1_sel_wr");
    sc_trace(mVcdFile, control_V_1_sel, "control_V_1_sel");
    sc_trace(mVcdFile, control_V_1_load_A, "control_V_1_load_A");
    sc_trace(mVcdFile, control_V_1_load_B, "control_V_1_load_B");
    sc_trace(mVcdFile, control_V_1_state, "control_V_1_state");
    sc_trace(mVcdFile, control_V_1_state_cmp_full, "control_V_1_state_cmp_full");
    ...
    sc_trace(mVcdFile, ctrl_V_TDATA_blk_n, "ctrl_V_TDATA_blk_n");
    sc_trace(mVcdFile, din_TDATA_blk_n, "din_TDATA_blk_n");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, tmp_7_fu_143_p2, "tmp_7_fu_143_p2");
    ...
    sc_trace(mVcdFile, tmp_data_V_reg_184, "tmp_data_V_reg_184");
    sc_trace(mVcdFile, temp_data_V_1_fu_159_p1, "temp_data_V_1_fu_159_p1");
    sc_trace(mVcdFile, temp_data_V_1_reg_192, "temp_data_V_1_reg_192");
    sc_trace(mVcdFile, ap_block_state3, "ap_block_state3");
    sc_trace(mVcdFile, ap_block_state3_io, "ap_block_state3_io");
    sc_trace(mVcdFile, tmp_tlast_fu_163_p2, "tmp_tlast_fu_163_p2");
    sc_trace(mVcdFile, tmp_data_V_4_cast_fu_170_p3, "tmp_data_V_4_cast_fu_170_p3");
    sc_trace(mVcdFile, lhs_V_reg_122, "lhs_V_reg_122");
    sc_trace(mVcdFile, ap_block_state2_io, "ap_block_state2_io");
    sc_trace(mVcdFile, tmp_1_fu_135_p1, "tmp_1_fu_135_p1");
    sc_trace(mVcdFile, tmp_4_fu_149_p4, "tmp_4_fu_149_p4");
...
void llr::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        control_V_1_sel_wr = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, control_V_1_vld_in.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, control_V_1_ack_in.read()))) {
            control_V_1_sel_wr =  (sc_logic) (~control_V_1_sel_wr.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ctrl_V_0_sel_rd = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_ack_out.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_vld_out.read()))) {
            ctrl_V_0_sel_rd =  (sc_logic) (~ctrl_V_0_sel_rd.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ctrl_V_0_sel_wr = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_vld_in.read()) && 
             esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_ack_in.read()))) {
            ctrl_V_0_sel_wr =  (sc_logic) (~ctrl_V_0_sel_wr.read());
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ctrl_V_0_state = ap_const_lv2_0;
    } else {
        if (((esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_in.read()) && 
              esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_ack_out.read()) && 
              esl_seteq<1,2,2>(ap_const_lv2_3, ctrl_V_0_state.read())) || 
             (esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_in.read()) && 
              esl_seteq<1,2,2>(ap_const_lv2_2, ctrl_V_0_state.read())))) {
            ctrl_V_0_state = ap_const_lv2_2;
        } else if (((esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_vld_in.read()) && 
                     esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_3, ctrl_V_0_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, ctrl_V_0_state.read())))) {
            ctrl_V_0_state = ap_const_lv2_1;
        } else if (((esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_vld_in.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_2, ctrl_V_0_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, ctrl_V_0_state.read())) || 
                    (esl_seteq<1,2,2>(ap_const_lv2_3, ctrl_V_0_state.read()) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_ack_out.read())) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_ack_out.read()))))) {
            ctrl_V_0_state = ap_const_lv2_3;
        } else {
            ctrl_V_0_state = ap_const_lv2_2;
        }
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
        ...
        lhs_V_reg_122 = temp_data_V_1_reg_192.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_block_state2_io.read(), ap_const_boolean_0))) {
        lhs_V_reg_122 = tmp_data_V_reg_184.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, control_V_1_load_A.read())) {
        control_V_1_payload_A = ctrl_V_0_data_out.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, control_V_1_load_B.read())) {
        control_V_1_payload_B = ctrl_V_0_data_out.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_load_A.read())) {
        ctrl_V_0_payload_A = ctrl_V_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_load_B.read())) {
        ctrl_V_0_payload_B = ctrl_V_TDATA.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, din_V_data_V_1_load_A.read())) {
        din_V_data_V_1_payload_A = tmp_data_V_4_cast_fu_170_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, din_V_data_V_1_load_B.read())) {
        din_V_data_V_1_payload_B = tmp_data_V_4_cast_fu_170_p3.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, din_V_tlast_1_load_A.read())) {
        din_V_tlast_1_payload_A =  (sc_logic) (tmp_tlast_fu_163_p2.read()[0]);
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, din_V_tlast_1_load_B.read())) {
        din_V_tlast_1_payload_B =  (sc_logic) (tmp_tlast_fu_163_p2.read()[0]);
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_7_fu_143_p2.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, control_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, din_words_V_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dout_words_V_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, din_V_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, din_V_tlast_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, din_words_V_tlast_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dout_words_V_tlast_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state3_io.read())))) {
        temp_data_V_1_reg_192 = temp_data_V_1_fu_159_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dt_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
        tmp_data_V_reg_184 = dt_V_data_V_0_data_out.read();
    }
}
...
void llr::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dt_V_data_V_0_vld_out.read()));
}
...
void llr::thread_ap_block_state3_io() {
    ap_block_state3_io = (esl_seteq<1,1,1>(ap_const_lv1_0, tmp_7_fu_143_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, din_V_data_V_1_ack_in.read()));
}
...
void llr::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_1, tmp_7_fu_143_p2.read()))) {
...
void llr::thread_control_V_1_data_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, control_V_1_sel.read())) {
        control_V_1_data_out = control_V_1_payload_B.read();
    } else {
        control_V_1_data_out = control_V_1_payload_A.read();
    }
}

void llr::thread_control_V_1_load_A() {
    control_V_1_load_A = (control_V_1_state_cmp_full.read() & ~control_V_1_sel_wr.read());
}

void llr::thread_control_V_1_load_B() {
    control_V_1_load_B = (control_V_1_sel_wr.read() & control_V_1_state_cmp_full.read());
}
...
void llr::thread_control_V_1_state_cmp_full() {
    control_V_1_state_cmp_full =  (sc_logic) ((!control_V_1_state.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<1>(): sc_lv<1>(control_V_1_state.read() != ap_const_lv2_1))[0];
}

void llr::thread_control_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dt_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
...
void llr::thread_ctrl_V_0_ack_in() {
    ctrl_V_0_ack_in = ctrl_V_0_state.read()[1];
}

void llr::thread_ctrl_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, ctrl_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_logic_0, dt_V_data_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
...
void llr::thread_ctrl_V_0_data_out() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ctrl_V_0_sel.read())) {
        ctrl_V_0_data_out = ctrl_V_0_payload_B.read();
    } else {
        ctrl_V_0_data_out = ctrl_V_0_payload_A.read();
    }
}

void llr::thread_ctrl_V_0_load_A() {
    ctrl_V_0_load_A = (ctrl_V_0_state_cmp_full.read() & ~ctrl_V_0_sel_wr.read());
}

void llr::thread_ctrl_V_0_load_B() {
    ctrl_V_0_load_B = (ctrl_V_0_sel_wr.read() & ctrl_V_0_state_cmp_full.read());
}

void llr::thread_ctrl_V_0_sel() {
    ctrl_V_0_sel = ctrl_V_0_sel_rd.read();
}

void llr::thread_ctrl_V_0_state_cmp_full() {
    ctrl_V_0_state_cmp_full =  (sc_logic) ((!ctrl_V_0_state.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<1>(): sc_lv<1>(ctrl_V_0_state.read() != ap_const_lv2_1))[0];
}

void llr::thread_ctrl_V_0_vld_in() {
    ctrl_V_0_vld_in = ctrl_V_TVALID.read();
}

void llr::thread_ctrl_V_0_vld_out() {
    ctrl_V_0_vld_out = ctrl_V_0_state.read()[0];
}

void llr::thread_ctrl_V_TDATA_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        ctrl_V_TDATA_blk_n = ctrl_V_0_state.read()[0];
    } else {
        ctrl_V_TDATA_blk_n = ap_const_logic_1;
    }
}

void llr::thread_ctrl_V_TREADY() {
    ctrl_V_TREADY = ctrl_V_0_state.read()[1];
}
...
void llr::thread_din_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, tmp_7_fu_143_p2.read())) || 
...
void llr::thread_temp_data_V_1_fu_159_p1() {
    temp_data_V_1_fu_159_p1 = esl_sext<128,127>(tmp_4_fu_149_p4.read());
}

void llr::thread_tmp_1_fu_135_p1() {
    tmp_1_fu_135_p1 = lhs_V_reg_122.read().range(64-1, 0);
}

void llr::thread_tmp_2_fu_139_p1() {
    tmp_2_fu_139_p1 = lhs_V_reg_122.read().range(1-1, 0);
}

void llr::thread_tmp_4_fu_149_p4() {
    tmp_4_fu_149_p4 = lhs_V_reg_122.read().range(127, 1);
}

void llr::thread_tmp_7_fu_143_p2() {
    tmp_7_fu_143_p2 = (!tmp_1_fu_135_p1.read().is_01() || !ap_const_lv64_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_1_fu_135_p1.read() == ap_const_lv64_0);
}

void llr::thread_tmp_data_V_4_cast_fu_170_p3() {
    tmp_data_V_4_cast_fu_170_p3 = (!tmp_2_fu_139_p1.read()[0].is_01())? sc_lv<128>(): ((tmp_2_fu_139_p1.read()[0].to_bool())? ap_const_lv128_lc_1: ap_const_lv128_lc_2);
}

void llr::thread_tmp_tlast_fu_163_p2() {
    tmp_tlast_fu_163_p2 = (!tmp_4_fu_149_p4.read().is_01() || !ap_const_lv127_0.is_01())? sc_lv<1>(): sc_lv<1>(tmp_4_fu_149_p4.read() == ap_const_lv127_0);
}
...
void llr::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvinHandle << " , " <<  " \"ctrl_V_TDATA\" :  \"" << ctrl_V_TDATA.read() << "\" ";
        mHdltvinHandle << " , " <<  " \"ctrl_V_TVALID\" :  \"" << ctrl_V_TVALID.read() << "\" ";
        mHdltvoutHandle << " , " <<  " \"ctrl_V_TREADY\" :  \"" << ctrl_V_TREADY.read() << "\" ";
