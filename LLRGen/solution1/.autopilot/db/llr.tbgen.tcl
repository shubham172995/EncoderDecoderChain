...
set C_modelArgList {
	...
	{ ctrl_V int 32 regular {axi_s 0 volatile  { ctrl_V Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "dt_V_data_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[{"low":0,"up":127,"cElement": [{"cName": "dt.V.data.V","cData": "int128","bit_use": { "low": 0,"up": 127},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "ctrl_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "ctrl.V","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ ctrl_V_TDATA sc_in sc_lv 32 signal 2 } 
	{ ctrl_V_TVALID sc_in sc_logic 1 invld 2 } 
	{ ctrl_V_TREADY sc_out sc_logic 1 inacc 2 } 
	{ din_TDATA sc_out sc_lv 128 signal 3 } 
	{ din_TVALID sc_out sc_logic 1 outvld 4 } 
	{ din_TREADY sc_in sc_logic 1 outacc 3 } 
	{ din_TLAST sc_out sc_logic 1 signal 4 } 
	{ control_V_TDATA sc_out sc_lv 32 signal 5 } 
	{ control_V_TVALID sc_out sc_logic 1 outvld 5 } 
	{ control_V_TREADY sc_in sc_logic 1 outacc 5 } 
	{ din_words_TDATA sc_out sc_lv 8 signal 6 } 
	{ din_words_TVALID sc_out sc_logic 1 outvld 7 } 
	{ din_words_TREADY sc_in sc_logic 1 outacc 6 } 
	{ din_words_TLAST sc_out sc_logic 1 signal 7 } 
	{ dout_words_TDATA sc_out sc_lv 8 signal 8 } 
	{ dout_words_TVALID sc_out sc_logic 1 outvld 9 } 
	{ dout_words_TREADY sc_in sc_logic 1 outacc 8 } 
	{ dout_words_TLAST sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ctrl_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ctrl_V", "role": "TDATA" }} , 
 	{ "name": "ctrl_V_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "ctrl_V", "role": "TVALID" }} , 
 	{ "name": "ctrl_V_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "ctrl_V", "role": "TREADY" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "ctrl_V", "Type" : "Axis", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "ctrl_V_TDATA_blk_n", "Type" : "RtlSignal"}]},
...
set ArgLastReadFirstWriteLatency {
	llr {
		...
		ctrl_V {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	ctrl_V { axis {  { ctrl_V_TDATA in_data 0 32 }  { ctrl_V_TVALID in_vld 0 1 }  { ctrl_V_TREADY in_acc 1 1 } } }
